...
# define ASIO_INITFN_RESULT_TYPE(h, sig) \
  typename ::tiny_rpc_asio::detail::async_result_type_helper<h, sig>::type
#else
# define ASIO_INITFN_RESULT_TYPE(h, sig) \
  typename ::tiny_rpc_asio::async_result< \
    typename ::tiny_rpc_asio::handler_type<h, sig>::type>::type
#endif
