...
protected:
   ...
   */
  explicit basic_io_object(tiny_rpc_asio::io_service& io_service)
    : service(tiny_rpc_asio::use_service<IoObjectService>(io_service))
  {
...
protected:
  explicit basic_io_object(tiny_rpc_asio::io_service& io_service)
    : service_(&tiny_rpc_asio::use_service<IoObjectService>(io_service))
  {
