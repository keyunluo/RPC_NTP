 ...
 *
 * @code tiny_rpc_asio::mutable_buffer b1 = ...;
 * std::size_t s1 = tiny_rpc_asio::buffer_size(b1);
 * unsigned char* p1 = tiny_rpc_asio::buffer_cast<unsigned char*>(b1);
 * @endcode
 *
 * The tiny_rpc_asio::buffer_cast function permits violations of type safety, so
...
public:
...
#if defined(ASIO_ENABLE_BUFFER_DEBUGGING)
  mutable_buffer(void* data, std::size_t size,
      tiny_rpc_asio::detail::function<void()> debug_check)
    : data_(data),
      size_(size),
  ...
  const tiny_rpc_asio::detail::function<void()>& get_debug_check() const
  {
    return debug_check_;
  }
#endif // ASIO_ENABLE_BUFFER_DEBUGGING
...
private:
  friend void* tiny_rpc_asio::detail::buffer_cast_helper(
      const mutable_buffer& b);
  friend std::size_t tiny_rpc_asio::detail::buffer_size_helper(
      const mutable_buffer& b);
...
#if defined(ASIO_ENABLE_BUFFER_DEBUGGING)
  tiny_rpc_asio::detail::function<void()> debug_check_;
#endif // ASIO_ENABLE_BUFFER_DEBUGGING
};
 ...
 * and @ref buffer_cast functions:
 *
 * @code tiny_rpc_asio::const_buffer b1 = ...;
 * std::size_t s1 = tiny_rpc_asio::buffer_size(b1);
 * const unsigned char* p1 = tiny_rpc_asio::buffer_cast<const unsigned char*>(b1);
 * @endcode
 *
 * The tiny_rpc_asio::buffer_cast function permits violations of type safety, so
 * uses of it in application code should be carefully considered.
...
public:
  ...
  const_buffer(const mutable_buffer& b)
    : data_(tiny_rpc_asio::detail::buffer_cast_helper(b)),
      size_(tiny_rpc_asio::detail::buffer_size_helper(b))
#if defined(ASIO_ENABLE_BUFFER_DEBUGGING)
...
private:
  friend const void* tiny_rpc_asio::detail::buffer_cast_helper(
...
/** @defgroup buffer_size tiny_rpc_asio::buffer_size
 *
 * @brief The tiny_rpc_asio::buffer_size function determines the total number of
...
/** @defgroup buffer_cast tiny_rpc_asio::buffer_cast
 *
 * @brief The tiny_rpc_asio::buffer_cast function is used to obtain a pointer to
 ...
 * @code tiny_rpc_asio::mutable_buffer b2 = ...;
 * unsigned char* p2 = tiny_rpc_asio::buffer_cast<unsigned char*>(b2);
 * @endcode
 *
 * The tiny_rpc_asio::buffer_cast function permits violations of type safety, so
 * uses of it in application code should be carefully considered.
...
/** @defgroup buffer tiny_rpc_asio::buffer
 *
 * @brief The tiny_rpc_asio::buffer function is used to create a buffer object to
 ...
 * specified size:
 *
 * @code sock.send(tiny_rpc_asio::buffer(data, size)); @endcode
 *
 * In the above example, the return value of tiny_rpc_asio::buffer meets the
 ...
 *
 * @code char d1[128];
 * size_t bytes_transferred = sock.receive(tiny_rpc_asio::buffer(d1));
 *
 * std::vector<char> d2(128);
 * bytes_transferred = sock.receive(tiny_rpc_asio::buffer(d2));
 *
 * std::array<char, 128> d3;
 * bytes_transferred = sock.receive(tiny_rpc_asio::buffer(d3));
 *
 * boost::array<char, 128> d4;
 * bytes_transferred = sock.receive(tiny_rpc_asio::buffer(d4)); @endcode
 *
 ...
 * unsigned char* p1 = tiny_rpc_asio::buffer_cast<unsigned char*>(b1);
 *
 * tiny_rpc_asio::const_buffer b2 = ...;
 * std::size_t s2 = tiny_rpc_asio::buffer_size(b2);
 * const void* p2 = tiny_rpc_asio::buffer_cast<const void*>(b2); @endcode
 *
 * The tiny_rpc_asio::buffer_cast function permits violations of type safety, so
 * uses of it in application code should be carefully considered.
 *
 ...
 *
 * vector<unsigned char> data(tiny_rpc_asio::buffer_size(buffers));
 * tiny_rpc_asio::buffer_copy(tiny_rpc_asio::buffer(data), buffers); @endcode
 *
 ...
 *
 * For the tiny_rpc_asio::buffer overloads that accept an argument of type
 ...
 *
 * @code b1 = tiny_rpc_asio::buffer(a); @endcode
 *
 * represents the entire array, <tt>{ 'a', 'b', 'c', 'd', 'e' }</tt>. An
 * optional second argument to the tiny_rpc_asio::buffer function may be used to
 * limit the size, in bytes, of the buffer:
 *
 * @code b2 = tiny_rpc_asio::buffer(a, 3); @endcode
 *
 ...
 *
 * @code b4 = tiny_rpc_asio::buffer(b1 + 1, 3); @endcode
 *
 ...
 *   tiny_rpc_asio::buffer(d1),
 *   tiny_rpc_asio::buffer(d2),
 *   tiny_rpc_asio::buffer(d3) };
 * bytes_transferred = sock.receive(bufs1);
 *
 * std::vector<const_buffer> bufs2;
 * bufs2.push_back(tiny_rpc_asio::buffer(d1));
 * bufs2.push_back(tiny_rpc_asio::buffer(d2));
 * bufs2.push_back(tiny_rpc_asio::buffer(d3));
...
{
  typedef typename tiny_rpc_asio::detail::buffer_types<PodType>::buffer_type
    buffer_type;
  typedef typename tiny_rpc_asio::detail::buffer_types<PodType>::container_type
    container_type;
...
/** @defgroup buffer_copy tiny_rpc_asio::buffer_copy
 *
 * @brief The tiny_rpc_asio::buffer_copy function is used to copy bytes from a
