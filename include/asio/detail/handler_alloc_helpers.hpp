...
#else
  using tiny_rpc_asio::clmdep_asio_handler_allocate;
  return clmdep_asio_handler_allocate(s, tiny_rpc_asio::detail::addressof(h));
#endif
}
...
inline void deallocate(void* p, std::size_t s, Handler& h)
{
  ...
  ::operator delete(p);
#else
  using tiny_rpc_asio::clmdep_asio_handler_deallocate;
  clmdep_asio_handler_deallocate(p, s, tiny_rpc_asio::detail::addressof(h));
#endif
}
