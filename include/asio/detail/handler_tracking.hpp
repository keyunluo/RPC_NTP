...
public:
  ...
  public:
    ...
    ASIO_DECL void invocation_begin(const tiny_rpc_asio::error_code& ec);
    ...
    // Constructor records that handler is to be invoked with two arguments.
    ASIO_DECL void invocation_begin(
        const tiny_rpc_asio::error_code& ec, int signal_number);

    // Constructor records that handler is to be invoked with two arguments.
    ASIO_DECL void invocation_begin(
        const tiny_rpc_asio::error_code& ec, const char* arg);
...
# define ASIO_INHERIT_TRACKED_HANDLER \
  : public tiny_rpc_asio::detail::handler_tracking::tracked_handler

# define ASIO_ALSO_INHERIT_TRACKED_HANDLER \
  , public tiny_rpc_asio::detail::handler_tracking::tracked_handler

# define ASIO_HANDLER_TRACKING_INIT \
  tiny_rpc_asio::detail::handler_tracking::init()

# define ASIO_HANDLER_CREATION(args) \
  tiny_rpc_asio::detail::handler_tracking::creation args

# define ASIO_HANDLER_COMPLETION(args) \
  tiny_rpc_asio::detail::handler_tracking::completion tracked_completion args
...
# define ASIO_HANDLER_OPERATION(args) \
  tiny_rpc_asio::detail::handler_tracking::operation args
