...
#define ASIO_COMPLETION_HANDLER_CHECK( \
  ...
  ASIO_HANDLER_TYPE_REQUIREMENTS_ASSERT( \
      sizeof(tiny_rpc_asio::detail::zero_arg_handler_test( \
          tiny_rpc_asio::detail::clvref< \
            clmdep_asio_true_handler_type>(), 0)) == 1, \
      "CompletionHandler type requirements not met") \
  \
  typedef tiny_rpc_asio::detail::handler_type_requirements< \
      sizeof( \
        tiny_rpc_asio::detail::argbyv( \
          tiny_rpc_asio::detail::clvref< \
            clmdep_asio_true_handler_type>())) + \
      sizeof( \
        tiny_rpc_asio::detail::lvref< \
          clmdep_asio_true_handler_type>()(), \
...
#define ASIO_READ_HANDLER_CHECK( \
  ...
  \
  ASIO_HANDLER_TYPE_REQUIREMENTS_ASSERT( \
      sizeof(tiny_rpc_asio::detail::two_arg_handler_test( \
          tiny_rpc_asio::detail::clvref< \
            clmdep_asio_true_handler_type>(), \
          static_cast<const tiny_rpc_asio::error_code*>(0), \
  ...
  typedef tiny_rpc_asio::detail::handler_type_requirements< \
      ...
      sizeof( \
        tiny_rpc_asio::detail::lvref< \
          clmdep_asio_true_handler_type>()( \
            tiny_rpc_asio::detail::lvref<const tiny_rpc_asio::error_code>(), \
            tiny_rpc_asio::detail::lvref<const std::size_t>()), \
        char(0))> ASIO_UNUSED_TYPEDEF
...
#define ASIO_ACCEPT_HANDLER_CHECK( \
  ...
  \
  ASIO_HANDLER_TYPE_REQUIREMENTS_ASSERT( \
      sizeof(tiny_rpc_asio::detail::one_arg_handler_test( \
          tiny_rpc_asio::detail::clvref< \
            clmdep_asio_true_handler_type>(), \
          static_cast<const tiny_rpc_asio::error_code*>(0))) == 1, \
...
#define ASIO_COMPOSED_CONNECT_HANDLER_CHECK( \
  ...
  \
  typedef ASIO_HANDLER_TYPE(handler_type, \
      void(tiny_rpc_asio::error_code, iter_type)) \
    clmdep_asio_true_handler_type; \
  \
  ASIO_HANDLER_TYPE_REQUIREMENTS_ASSERT( \
      sizeof(tiny_rpc_asio::detail::two_arg_handler_test( \
  ...
  typedef tiny_rpc_asio::detail::handler_type_requirements< \
      ...
      sizeof( \
        tiny_rpc_asio::detail::lvref< \
          clmdep_asio_true_handler_type>()( \
            tiny_rpc_asio::detail::lvref<const tiny_rpc_asio::error_code>(), \
            tiny_rpc_asio::detail::lvref<const iter_type>()), \
        char(0))> ASIO_UNUSED_TYPEDEF
  ...
  typedef tiny_rpc_asio::detail::handler_type_requirements< \
      ...
      sizeof( \
        tiny_rpc_asio::detail::lvref< \
          clmdep_asio_true_handler_type>()( \
            tiny_rpc_asio::detail::lvref<const tiny_rpc_asio::error_code>(), \
            tiny_rpc_asio::detail::lvref<const int>()), \
        char(0))> ASIO_UNUSED_TYPEDEF
