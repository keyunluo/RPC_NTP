...
select_reactor::select_reactor(tiny_rpc_asio::io_service& io_service)
  : tiny_rpc_asio::detail::service_base<select_reactor>(io_service),
...
{
#if defined(ASIO_HAS_IOCP)
  tiny_rpc_asio::detail::signal_blocker sb;
  thread_ = new tiny_rpc_asio::detail::thread(
...
void select_reactor::fork_service(tiny_rpc_asio::io_service::fork_event fork_ev)
{
