...
struct task_io_service::task_cleanup
{
  ~task_cleanup()
  {
    ...
    {
      tiny_rpc_asio::detail::increment(
...
task_io_service::task_io_service(
    tiny_rpc_asio::io_service& io_service, std::size_t concurrency_hint)
  : tiny_rpc_asio::detail::service_base<task_io_service>(io_service),
...
std::size_t task_io_service::run(tiny_rpc_asio::error_code& ec)
{
...
std::size_t task_io_service::run_one(tiny_rpc_asio::error_code& ec)
{
  ec = tiny_rpc_asio::error_code();
  if (outstanding_work_ == 0)
  {
...
std::size_t task_io_service::poll(tiny_rpc_asio::error_code& ec)
{
  ec = tiny_rpc_asio::error_code();
  if (outstanding_work_ == 0)
  {
...
std::size_t task_io_service::poll_one(tiny_rpc_asio::error_code& ec)
{
  ec = tiny_rpc_asio::error_code();
  if (outstanding_work_ == 0)
  {
