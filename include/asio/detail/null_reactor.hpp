...
class null_reactor
  : public tiny_rpc_asio::detail::service_base<null_reactor>
{
public:
  // Constructor.
  null_reactor(tiny_rpc_asio::io_service& io_service)
    : tiny_rpc_asio::detail::service_base<null_reactor>(io_service)
  {
  }
