...
public:
  ...
  // Constructor.
  null_socket_service(tiny_rpc_asio::io_service& io_service)
  ...
  tiny_rpc_asio::error_code open(implementation_type&,
      const protocol_type&, tiny_rpc_asio::error_code& ec)
  {
  ...
  tiny_rpc_asio::error_code assign(implementation_type&, const protocol_type&,
      const native_handle_type&, tiny_rpc_asio::error_code& ec)
  {
    ec = tiny_rpc_asio::error::operation_not_supported;
    return ec;
  }
  ...
  // Destroy a socket implementation.
  tiny_rpc_asio::error_code close(implementation_type&,
  ...
  tiny_rpc_asio::error_code cancel(implementation_type&,
      tiny_rpc_asio::error_code& ec)
  {
    ec = tiny_rpc_asio::error::operation_not_supported;
    return ec;
  ...
  tiny_rpc_asio::error_code listen(implementation_type&,
      int, tiny_rpc_asio::error_code& ec)
  {
    ec = tiny_rpc_asio::error::operation_not_supported;
    return ec;
  }
  ...
  tiny_rpc_asio::error_code io_control(implementation_type&,
  ...
  tiny_rpc_asio::error_code non_blocking(implementation_type&,
  ...
  tiny_rpc_asio::error_code native_non_blocking(implementation_type&,
      bool, tiny_rpc_asio::error_code& ec)
  {
    ec = tiny_rpc_asio::error::operation_not_supported;
    return ec;
  ...
  tiny_rpc_asio::error_code shutdown(implementation_type&,
  ...
  tiny_rpc_asio::error_code bind(implementation_type&,
      const endpoint_type&, tiny_rpc_asio::error_code& ec)
  {
    ec = tiny_rpc_asio::error::operation_not_supported;
    return ec;
  }
  ...
  tiny_rpc_asio::error_code set_option(implementation_type&,
      const Option&, tiny_rpc_asio::error_code& ec)
  {
    ec = tiny_rpc_asio::error::operation_not_supported;
    return ec;
  }
  ...
  // Set a socket option.
  template <typename Option>
  tiny_rpc_asio::error_code get_option(const implementation_type&,
      Option&, tiny_rpc_asio::error_code& ec) const
  {
    ec = tiny_rpc_asio::error::operation_not_supported;
    return ec;
  }
  ...
  tiny_rpc_asio::error_code accept(implementation_type&,
      Socket&, endpoint_type*, tiny_rpc_asio::error_code& ec)
  {
    ec = tiny_rpc_asio::error::operation_not_supported;
    return ec;
  }
  ...
  tiny_rpc_asio::error_code connect(implementation_type&,
      const endpoint_type&, tiny_rpc_asio::error_code& ec)
  {
    ec = tiny_rpc_asio::error::operation_not_supported;
    return ec;
