...
public:
  ...
  class implementation_type
    : private tiny_rpc_asio::detail::noncopyable
  {
  public:
    // Default constructor.
    implementation_type()
  ...
  ASIO_DECL tiny_rpc_asio::error_code assign(implementation_type& impl,
  ...
  // Destroy a descriptor implementation.
  ASIO_DECL tiny_rpc_asio::error_code close(implementation_type& impl,
      tiny_rpc_asio::error_code& ec);
  ...
  ASIO_DECL tiny_rpc_asio::error_code cancel(implementation_type& impl,
      tiny_rpc_asio::error_code& ec);
  ...
  size_t write_some(implementation_type& impl,
      const null_buffers&, tiny_rpc_asio::error_code& ec)
  {
