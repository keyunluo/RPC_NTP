...
public:
  ...
  // Constructor.
  ASIO_DECL signal_set_service(tiny_rpc_asio::io_service& io_service);
  ...
  ASIO_DECL tiny_rpc_asio::error_code add(implementation_type& impl,
      int signal_number, tiny_rpc_asio::error_code& ec);

  // Remove a signal to a signal_set.
  ASIO_DECL tiny_rpc_asio::error_code remove(implementation_type& impl,
      int signal_number, tiny_rpc_asio::error_code& ec);

  // Remove all signals from a signal_set.
  ASIO_DECL tiny_rpc_asio::error_code clear(implementation_type& impl,
