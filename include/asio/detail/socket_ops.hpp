...
ASIO_DECL int shutdown(socket_type s,
    int what, tiny_rpc_asio::error_code& ec);
...
ASIO_DECL bool sockatmark(socket_type s, tiny_rpc_asio::error_code& ec);

ASIO_DECL size_t available(socket_type s, tiny_rpc_asio::error_code& ec);

ASIO_DECL int listen(socket_type s,
    int backlog, tiny_rpc_asio::error_code& ec);
...
ASIO_DECL signed_size_type recv(socket_type s, buf* bufs,
    size_t count, int flags, tiny_rpc_asio::error_code& ec);
...
ASIO_DECL size_t sync_send(socket_type s, state_type state,
    ...
    bool all_empty, tiny_rpc_asio::error_code& ec);
...
ASIO_DECL int setsockopt(socket_type s, state_type& state,
    ...
    std::size_t optlen, tiny_rpc_asio::error_code& ec);

ASIO_DECL int getsockopt(socket_type s, state_type state,
    int level, int optname, void* optval,
    size_t* optlen, tiny_rpc_asio::error_code& ec);
...
ASIO_DECL int ioctl(socket_type s, state_type& state,
    int cmd, ioctl_arg_type* arg, tiny_rpc_asio::error_code& ec);
...
ASIO_DECL int poll_read(socket_type s,
    state_type state, tiny_rpc_asio::error_code& ec);

ASIO_DECL int poll_write(socket_type s,
    state_type state, tiny_rpc_asio::error_code& ec);

ASIO_DECL int poll_connect(socket_type s, tiny_rpc_asio::error_code& ec);

#endif // !defined(ASIO_WINDOWS_RUNTIME)

ASIO_DECL const char* inet_ntop(int af, const void* src, char* dest,
    size_t length, unsigned long scope_id, tiny_rpc_asio::error_code& ec);
...
ASIO_DECL int gethostname(char* name,
    int namelen, tiny_rpc_asio::error_code& ec);

#if !defined(ASIO_WINDOWS_RUNTIME)

ASIO_DECL tiny_rpc_asio::error_code getaddrinfo(const char* host,
    const char* service, const addrinfo_type& hints,
    addrinfo_type** result, tiny_rpc_asio::error_code& ec);

ASIO_DECL tiny_rpc_asio::error_code background_getaddrinfo(
...
ASIO_DECL tiny_rpc_asio::error_code getnameinfo(
    const socket_addr_type* addr, std::size_t addrlen,
    char* host, std::size_t hostlen, char* serv,
    std::size_t servlen, int flags, tiny_rpc_asio::error_code& ec);

ASIO_DECL tiny_rpc_asio::error_code sync_getnameinfo(
    const socket_addr_type* addr, std::size_t addrlen,
    char* host, std::size_t hostlen, char* serv,
    std::size_t servlen, int sock_type, tiny_rpc_asio::error_code& ec);

ASIO_DECL tiny_rpc_asio::error_code background_getnameinfo(
    const weak_cancel_token_type& cancel_token,
    const socket_addr_type* addr, std::size_t addrlen,
    char* host, std::size_t hostlen, char* serv,
    std::size_t servlen, int sock_type, tiny_rpc_asio::error_code& ec);
