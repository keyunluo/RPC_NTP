...
class strand_service
  : public tiny_rpc_asio::detail::service_base<strand_service>
{
private:
...
public:
  ...
  ASIO_DECL explicit strand_service(tiny_rpc_asio::io_service& io_service);
...
private:
  ...
  ASIO_DECL static void do_complete(io_service_impl* owner,
      operation* base, const tiny_rpc_asio::error_code& ec,
