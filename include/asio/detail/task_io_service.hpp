...
class task_io_service
  : public tiny_rpc_asio::detail::service_base<task_io_service>
{
public:
  ...
  ASIO_DECL task_io_service(tiny_rpc_asio::io_service& io_service,
...
private:
  ...
  ASIO_DECL std::size_t do_run_one(mutex::scoped_lock& lock,
      thread_info& this_thread, const tiny_rpc_asio::error_code& ec);
