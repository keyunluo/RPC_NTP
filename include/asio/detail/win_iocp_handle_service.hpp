...
public:
  ...
  ASIO_DECL win_iocp_handle_service(tiny_rpc_asio::io_service& io_service);
...
private:
  ...
  size_t write_some(implementation_type& impl,
      const null_buffers& buffers, tiny_rpc_asio::error_code& ec);
  size_t write_some_at(implementation_type& impl, uint64_t offset,
      const null_buffers& buffers, tiny_rpc_asio::error_code& ec);
  ...
  ASIO_DECL size_t do_write(implementation_type& impl,
      uint64_t offset, const tiny_rpc_asio::const_buffer& buffer,
      tiny_rpc_asio::error_code& ec);
  ...
  ASIO_DECL size_t do_read(implementation_type& impl,
      uint64_t offset, const tiny_rpc_asio::mutable_buffer& buffer,
      tiny_rpc_asio::error_code& ec);
