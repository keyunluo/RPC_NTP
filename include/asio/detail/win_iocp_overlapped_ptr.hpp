...
public:
  ...
  explicit win_iocp_overlapped_ptr(
      tiny_rpc_asio::io_service& io_service, ASIO_MOVE_ARG(Handler) handler)
    : ptr_(0),
      iocp_service_(0)
  {
  ...
  // object.
  template <typename Handler>
  void reset(tiny_rpc_asio::io_service& io_service, Handler handler)
  {
  ...
  void complete(const tiny_rpc_asio::error_code& ec,
