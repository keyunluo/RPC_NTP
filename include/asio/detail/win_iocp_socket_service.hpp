...
public:
  ...
  // Constructor.
  win_iocp_socket_service(tiny_rpc_asio::io_service& io_service)
  ...
  tiny_rpc_asio::error_code set_option(implementation_type& impl,
      const Option& option, tiny_rpc_asio::error_code& ec)
  {
  ...
  tiny_rpc_asio::error_code get_option(const implementation_type& impl,
      Option& option, tiny_rpc_asio::error_code& ec) const
  {
  ...
  tiny_rpc_asio::error_code accept(implementation_type& impl, Socket& peer,
