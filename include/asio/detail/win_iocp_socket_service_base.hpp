...
public:
  ...
  ASIO_DECL tiny_rpc_asio::error_code cancel(
      base_implementation_type& impl, tiny_rpc_asio::error_code& ec);
  ...
  tiny_rpc_asio::error_code listen(base_implementation_type& impl,
  ...
  tiny_rpc_asio::error_code io_control(base_implementation_type& impl,
      IO_Control_Command& command, tiny_rpc_asio::error_code& ec)
  {
  ...
  tiny_rpc_asio::error_code non_blocking(base_implementation_type& impl,
  ...
  tiny_rpc_asio::error_code native_non_blocking(base_implementation_type& impl,
      bool mode, tiny_rpc_asio::error_code& ec)
  {
  ...
  tiny_rpc_asio::error_code shutdown(base_implementation_type& impl,
...
protected:
  ...
  ASIO_DECL tiny_rpc_asio::error_code do_open(
      base_implementation_type& impl, int family, int type,
      int protocol, tiny_rpc_asio::error_code& ec);

  // Assign a native socket to a socket implementation.
  ASIO_DECL tiny_rpc_asio::error_code do_assign(
      base_implementation_type& impl, int type,
      socket_type native_socket, tiny_rpc_asio::error_code& ec);
