...
class winrt_async_manager
  : public tiny_rpc_asio::detail::service_base<winrt_async_manager>
{
public:
  // Constructor.
  winrt_async_manager(tiny_rpc_asio::io_service& io_service)
    : tiny_rpc_asio::detail::service_base<winrt_async_manager>(io_service),
      ...
      tiny_rpc_asio::error_code& ec)
  {
    ...
    auto promise = std::make_shared<std::promise<tiny_rpc_asio::error_code>>();
    ...
    action->Completed = ref new AsyncActionCompletedHandler(
      [promise](IAsyncAction^ action, AsyncStatus status)
      {
        ...
        case AsyncStatus::Canceled:
          promise->set_value(tiny_rpc_asio::error::operation_aborted);
          break;
      ...
      winrt_async_op<void>* handler)
  {
    ...
    auto on_completed = ref new AsyncActionCompletedHandler(
      [this, handler](IAsyncAction^ action, AsyncStatus status)
      {
        ...
        {
        case AsyncStatus::Canceled:
          handler->ec_ = tiny_rpc_asio::error::operation_aborted;
          break;
        case AsyncStatus::Started:
          return;
        case AsyncStatus::Completed:
        case AsyncStatus::Error:
        default:
          handler->ec_ = tiny_rpc_asio::error_code(
              action->ErrorCode.Value,
              tiny_rpc_asio::system_category());
          break;
        }
