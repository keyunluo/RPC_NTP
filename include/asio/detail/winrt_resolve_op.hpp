...
public:
  ...
  static void do_complete(io_service_impl* owner, operation* base,
      const tiny_rpc_asio::error_code&, std::size_t)
  {
    // Take ownership of the operation object.
    winrt_resolve_op* o(static_cast<winrt_resolve_op*>(base));
    ptr p = { tiny_rpc_asio::detail::addressof(o->handler_), o, o };
    ...
    if (!o->ec_)
    {
      ...
      {
        o->ec_ = tiny_rpc_asio::error_code(e->HResult,
    ...
    detail::binder2<Handler, tiny_rpc_asio::error_code, iterator_type>
      handler(o->handler_, o->ec_, iterator);
    p.h = tiny_rpc_asio::detail::addressof(handler.handler_);
    p.reset();
