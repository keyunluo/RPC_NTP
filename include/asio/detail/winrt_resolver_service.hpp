...
public:
  ...
  // The query type.
  typedef tiny_rpc_asio::ip::basic_resolver_query<Protocol> query_type;

  // The iterator type.
  typedef tiny_rpc_asio::ip::basic_resolver_iterator<Protocol> iterator_type;

  // Constructor.
  winrt_resolver_service(tiny_rpc_asio::io_service& io_service)
  ...
  void fork_service(tiny_rpc_asio::io_service::fork_event)
  {
  }
  ...
  iterator_type resolve(implementation_type&,
      const query_type& query, tiny_rpc_asio::error_code& ec)
  {
    try
    {
      ...
      const query_type& query, Handler& handler)
  {
    ...
    {
      p.p->ec_ = tiny_rpc_asio::error_code(
