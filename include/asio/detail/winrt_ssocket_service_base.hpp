...
public:
  ...
  // Destroy a socket implementation.
  ASIO_DECL tiny_rpc_asio::error_code close(
      base_implementation_type& impl, tiny_rpc_asio::error_code& ec);
  ...
  tiny_rpc_asio::error_code cancel(base_implementation_type&,
  ...
  tiny_rpc_asio::error_code io_control(base_implementation_type&,
      IO_Control_Command&, tiny_rpc_asio::error_code& ec)
  {
    ec = tiny_rpc_asio::error::operation_not_supported;
    return ec;
  }
  ...
  tiny_rpc_asio::error_code non_blocking(base_implementation_type&,
      bool, tiny_rpc_asio::error_code& ec)
  {
    ec = tiny_rpc_asio::error::operation_not_supported;
    return ec;
  }
  ...
  tiny_rpc_asio::error_code native_non_blocking(base_implementation_type&,
      bool, tiny_rpc_asio::error_code& ec)
  {
    ec = tiny_rpc_asio::error::operation_not_supported;
    return ec;
  ...
  tiny_rpc_asio::error_code shutdown(base_implementation_type&,
      socket_base::shutdown_type, tiny_rpc_asio::error_code& ec)
  {
    ec = tiny_rpc_asio::error::operation_not_supported;
    return ec;
  }
  ...
  std::size_t send(base_implementation_type&, const null_buffers&,
      socket_base::message_flags, tiny_rpc_asio::error_code& ec)
  {
    ec = tiny_rpc_asio::error::operation_not_supported;
    return 0;
  }
      ...
      socket_base::message_flags flags, Handler& handler)
  {
    ...
    typename op::ptr p = { tiny_rpc_asio::detail::addressof(handler),
  ...
  {
    tiny_rpc_asio::error_code ec = tiny_rpc_asio::error::operation_not_supported;
...
protected:
  ...
  ASIO_DECL tiny_rpc_asio::error_code do_set_option(
  ...
  ASIO_DECL tiny_rpc_asio::error_code do_connect(
      base_implementation_type& impl,
  ...
  ASIO_DECL std::size_t do_send(
      base_implementation_type& impl, const tiny_rpc_asio::const_buffer& data,
      socket_base::message_flags flags, tiny_rpc_asio::error_code& ec);
  ...
  ASIO_DECL std::size_t do_receive(
      base_implementation_type& impl, const tiny_rpc_asio::mutable_buffer& data,
      socket_base::message_flags flags, tiny_rpc_asio::error_code& ec);
  ...
  tiny_rpc_asio::detail::mutex mutex_;
