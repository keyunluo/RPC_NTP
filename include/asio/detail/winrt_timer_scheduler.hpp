...
class winrt_timer_scheduler
  : public tiny_rpc_asio::detail::service_base<winrt_timer_scheduler>
{
public:
  // Constructor.
  ASIO_DECL winrt_timer_scheduler(tiny_rpc_asio::io_service& io_service);
...
private:
  ...
  tiny_rpc_asio::detail::event event_;

  // The timer queues.
  timer_queue_set timer_queues_;

  // The background thread that is waiting for timers to expire.
  tiny_rpc_asio::detail::thread* thread_;
