...
inline const tiny_rpc_asio::error_category& get_system_category()
{
  return tiny_rpc_asio::system_category();
}

#if !defined(ASIO_WINDOWS) && !defined(__CYGWIN__)

extern ASIO_DECL
const tiny_rpc_asio::error_category& get_netdb_category();

extern ASIO_DECL
const tiny_rpc_asio::error_category& get_addrinfo_category();

#else // !defined(ASIO_WINDOWS) && !defined(__CYGWIN__)

inline const tiny_rpc_asio::error_category& get_netdb_category()
{
  return get_system_category();
}

inline const tiny_rpc_asio::error_category& get_addrinfo_category()
{
  return get_system_category();
}
...
extern ASIO_DECL
const tiny_rpc_asio::error_category& get_misc_category();

static const tiny_rpc_asio::error_category& system_category
  = tiny_rpc_asio::error::get_system_category();
static const tiny_rpc_asio::error_category& netdb_category
  = tiny_rpc_asio::error::get_netdb_category();
static const tiny_rpc_asio::error_category& addrinfo_category
  = tiny_rpc_asio::error::get_addrinfo_category();
static const tiny_rpc_asio::error_category& misc_category
  = tiny_rpc_asio::error::get_misc_category();
...
template<> struct is_error_code_enum<tiny_rpc_asio::error::basic_errors>
{
  static const bool value = true;
};

template<> struct is_error_code_enum<tiny_rpc_asio::error::netdb_errors>
{
  static const bool value = true;
};

template<> struct is_error_code_enum<tiny_rpc_asio::error::addrinfo_errors>
{
  static const bool value = true;
};

template<> struct is_error_code_enum<tiny_rpc_asio::error::misc_errors>
{
  static const bool value = true;
};
...
inline tiny_rpc_asio::error_code make_error_code(basic_errors e)
{
  return tiny_rpc_asio::error_code(
      static_cast<int>(e), get_system_category());
}

inline tiny_rpc_asio::error_code make_error_code(netdb_errors e)
{
  return tiny_rpc_asio::error_code(
      static_cast<int>(e), get_netdb_category());
}

inline tiny_rpc_asio::error_code make_error_code(addrinfo_errors e)
{
  return tiny_rpc_asio::error_code(
      static_cast<int>(e), get_addrinfo_category());
}

inline tiny_rpc_asio::error_code make_error_code(misc_errors e)
{
  return tiny_rpc_asio::error_code(
