...
inline std::size_t read(SyncReadStream& s, const MutableBufferSequence& buffers)
{
  ...
  tiny_rpc_asio::detail::throw_error(ec, "read");
...
namespace detail
{
  ...
  template <typename AsyncReadStream,
      typename CompletionCondition, typename ReadHandler>
  class read_op<AsyncReadStream, tiny_rpc_asio::mutable_buffers_1,
  ...
  public:
        ...
        std::size_t bytes_transferred, int start = 0)
    {
      typename tiny_rpc_asio::detail::dependent_type<Elem,
          boost::array<tiny_rpc_asio::mutable_buffer, 2> >::type bufs = {{
        tiny_rpc_asio::mutable_buffer(buffers_[0]),
        tiny_rpc_asio::mutable_buffer(buffers_[1]) }};
  ...
  public:
    ...
    {
      typename tiny_rpc_asio::detail::dependent_type<Elem,
          std::array<tiny_rpc_asio::mutable_buffer, 2> >::type bufs = {{
        tiny_rpc_asio::mutable_buffer(buffers_[0]),
        tiny_rpc_asio::mutable_buffer(buffers_[1]) }};
      std::size_t buffer_size0 = tiny_rpc_asio::buffer_size(bufs[0]);
      std::size_t buffer_size1 = tiny_rpc_asio::buffer_size(bufs[1]);
    ...
    ASIO_MOVE_ARG(ReadHandler) handler)
{
  ...
  detail::read_op<AsyncReadStream, MutableBufferSequence,
    CompletionCondition, ASIO_HANDLER_TYPE(
      ReadHandler, void (tiny_rpc_asio::error_code, std::size_t))>(
