    ...
    tiny_rpc_asio::basic_streambuf<Allocator>& b, char delim)
{
  ...
  tiny_rpc_asio::detail::throw_error(ec, "read_until");
    ...
    tiny_rpc_asio::error_code& ec)
{
  ...
  for (;;)
  {
    ...
    typedef typename tiny_rpc_asio::basic_streambuf<
      Allocator>::const_buffers_type const_buffers_type;
    typedef tiny_rpc_asio::buffers_iterator<const_buffers_type> iterator;
  ...
  public:
        ...
        std::size_t bytes_transferred, int start = 0)
    {
      ...
      case 1:
        ...
        const tiny_rpc_asio::error_code result_ec =
          (search_position_ == not_found)
          ? error::not_found : ec;
