...
tiny_rpc_asio::error_code serial_port_base::baud_rate::store(
    ASIO_OPTION_STORAGE& storage, tiny_rpc_asio::error_code& ec) const
{
...
tiny_rpc_asio::error_code serial_port_base::baud_rate::load(
    const ASIO_OPTION_STORAGE& storage, tiny_rpc_asio::error_code& ec)
{
#if defined(ASIO_WINDOWS) || defined(__CYGWIN__)
  ...
  : value_(t)
{
  if (t != none && t != software && t != hardware)
  {
    ...
    tiny_rpc_asio::detail::throw_exception(ex);
  }
}

tiny_rpc_asio::error_code serial_port_base::flow_control::store(
    ASIO_OPTION_STORAGE& storage, tiny_rpc_asio::error_code& ec) const
{
#if defined(ASIO_WINDOWS) || defined(__CYGWIN__)
...
tiny_rpc_asio::error_code serial_port_base::flow_control::load(
    const ASIO_OPTION_STORAGE& storage, tiny_rpc_asio::error_code& ec)
{
#if defined(ASIO_WINDOWS) || defined(__CYGWIN__)
...
tiny_rpc_asio::error_code serial_port_base::parity::store(
    ASIO_OPTION_STORAGE& storage, tiny_rpc_asio::error_code& ec) const
{
#if defined(ASIO_WINDOWS) || defined(__CYGWIN__)
  switch (value_)
...
tiny_rpc_asio::error_code serial_port_base::parity::load(
    const ASIO_OPTION_STORAGE& storage, tiny_rpc_asio::error_code& ec)
{
#if defined(ASIO_WINDOWS) || defined(__CYGWIN__)
...
tiny_rpc_asio::error_code serial_port_base::stop_bits::store(
    ASIO_OPTION_STORAGE& storage, tiny_rpc_asio::error_code& ec) const
{
#if defined(ASIO_WINDOWS) || defined(__CYGWIN__)
  switch (value_)
...
tiny_rpc_asio::error_code serial_port_base::stop_bits::load(
    const ASIO_OPTION_STORAGE& storage, tiny_rpc_asio::error_code& ec)
{
#if defined(ASIO_WINDOWS) || defined(__CYGWIN__)
...
tiny_rpc_asio::error_code serial_port_base::character_size::store(
    ASIO_OPTION_STORAGE& storage, tiny_rpc_asio::error_code& ec) const
{
#if defined(ASIO_WINDOWS) || defined(__CYGWIN__)
...
tiny_rpc_asio::error_code serial_port_base::character_size::load(
    const ASIO_OPTION_STORAGE& storage, tiny_rpc_asio::error_code& ec)
{
#if defined(ASIO_WINDOWS) || defined(__CYGWIN__)
