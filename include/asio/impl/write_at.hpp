...
std::size_t write_at(SyncRandomAccessWriteDevice& d,
    ...
    CompletionCondition completion_condition, tiny_rpc_asio::error_code& ec)
{
  ec = tiny_rpc_asio::error_code();
  tiny_rpc_asio::detail::consuming_buffers<
    ...
    uint64_t offset, const ConstBufferSequence& buffers)
{
  ...
  tiny_rpc_asio::detail::throw_error(ec, "write_at");
...
template <typename SyncRandomAccessWriteDevice, typename Allocator,
    typename CompletionCondition>
std::size_t write_at(SyncRandomAccessWriteDevice& d,
    uint64_t offset, tiny_rpc_asio::basic_streambuf<Allocator>& b,
    CompletionCondition completion_condition, tiny_rpc_asio::error_code& ec)
{
  std::size_t bytes_transferred = write_at(
...
namespace detail
{
  ...
  public:
    ...
    void operator()(const tiny_rpc_asio::error_code& ec,
  ...
  class write_at_op<AsyncRandomAccessWriteDevice,
      tiny_rpc_asio::mutable_buffers_1, CompletionCondition, WriteHandler>
    : detail::base_from_completion_cond<CompletionCondition>
  {
  public:
    write_at_op(AsyncRandomAccessWriteDevice& device,
        uint64_t offset, const tiny_rpc_asio::mutable_buffers_1& buffers,
        CompletionCondition completion_condition,
      ...
      switch (start_ = start)
      {
        ...
        for (;;)
        {
          device_.async_write_some_at(offset_ + total_transferred_,
              tiny_rpc_asio::buffer(buffer_ + total_transferred_, n),
              ASIO_MOVE_CAST(write_at_op)(*this));
          return; default:
          total_transferred_ += bytes_transferred;
          if ((!ec && bytes_transferred == 0)
              || (n = this->check_for_completion(ec, total_transferred_)) == 0
              || total_transferred_ == tiny_rpc_asio::buffer_size(buffer_))
            break;
        }
  ...
  //private:
    AsyncRandomAccessWriteDevice& device_;
    uint64_t offset_;
    tiny_rpc_asio::mutable_buffer buffer_;
    int start_;
    std::size_t total_transferred_;
    WriteHandler handler_;
  };
  ...
  template <typename AsyncRandomAccessWriteDevice,
      typename CompletionCondition, typename WriteHandler>
  class write_at_op<AsyncRandomAccessWriteDevice, tiny_rpc_asio::const_buffers_1,
      CompletionCondition, WriteHandler>
    : detail::base_from_completion_cond<CompletionCondition>
  {
  public:
    write_at_op(AsyncRandomAccessWriteDevice& device,
        uint64_t offset, const tiny_rpc_asio::const_buffers_1& buffers,
        CompletionCondition completion_condition,
        WriteHandler& handler)
      : detail::base_from_completion_cond<
          CompletionCondition>(completion_condition),
  ...
  //private:
    AsyncRandomAccessWriteDevice& device_;
    uint64_t offset_;
    tiny_rpc_asio::const_buffer buffer_;
    int start_;
    std::size_t total_transferred_;
    WriteHandler handler_;
  };
  ...
  public:
    ...
    void operator()(const tiny_rpc_asio::error_code& ec,
        std::size_t bytes_transferred, int start = 0)
    {
      typename tiny_rpc_asio::detail::dependent_type<Elem,
          boost::array<tiny_rpc_asio::const_buffer, 2> >::type bufs = {{
        tiny_rpc_asio::const_buffer(buffers_[0]),
        tiny_rpc_asio::const_buffer(buffers_[1]) }};
      std::size_t buffer_size0 = tiny_rpc_asio::buffer_size(bufs[0]);
      std::size_t buffer_size1 = tiny_rpc_asio::buffer_size(bufs[1]);
      std::size_t n = 0;
      switch (start_ = start)
      {
        case 1:
        ...
        for (;;)
        {
          bufs[0] = tiny_rpc_asio::buffer(bufs[0] + total_transferred_, n);
          bufs[1] = tiny_rpc_asio::buffer(
              bufs[1] + (total_transferred_ < buffer_size0
                ? 0 : total_transferred_ - buffer_size0),
              n - tiny_rpc_asio::buffer_size(bufs[0]));
          device_.async_write_some_at(offset_ + total_transferred_,
  ...
  public:
    ...
    {
      typename tiny_rpc_asio::detail::dependent_type<Elem,
          std::array<tiny_rpc_asio::const_buffer, 2> >::type bufs = {{
        tiny_rpc_asio::const_buffer(buffers_[0]),
        tiny_rpc_asio::const_buffer(buffers_[1]) }};
      std::size_t buffer_size0 = tiny_rpc_asio::buffer_size(bufs[0]);
      std::size_t buffer_size1 = tiny_rpc_asio::buffer_size(bufs[1]);
    ...
    ASIO_MOVE_ARG(WriteHandler) handler)
{
  ...
  detail::write_at_op<AsyncRandomAccessWriteDevice, ConstBufferSequence,
    CompletionCondition, ASIO_HANDLER_TYPE(
      WriteHandler, void (tiny_rpc_asio::error_code, std::size_t))>(
        d, offset, buffers, completion_condition, init.handler)(
          tiny_rpc_asio::error_code(), 0, 1);
...
namespace detail
{
  ...
  public:
    write_at_streambuf_op(
        tiny_rpc_asio::basic_streambuf<Allocator>& streambuf,
        WriteHandler& handler)
  ...
  //private:
    tiny_rpc_asio::basic_streambuf<Allocator>& streambuf_;
    WriteHandler handler_;
  };
  ...
  make_write_at_streambuf_op(
      tiny_rpc_asio::basic_streambuf<Allocator>& b, WriteHandler handler)
  {
