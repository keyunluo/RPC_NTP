...
/**
 * The tiny_rpc_asio::ip::address_v4 class provides the ability to use and
...
#else
  typedef tiny_rpc_asio::detail::array<unsigned char, 4> bytes_type;
#endif
...
private:
  ...
  tiny_rpc_asio::detail::in4_addr_type addr_;
};
 ...
 *
 * @relates tiny_rpc_asio::ip::address_v4
 */
