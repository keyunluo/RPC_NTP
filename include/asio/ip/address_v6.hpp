...
/**
 * The tiny_rpc_asio::ip::address_v6 class provides the ability to use and
...
#else
  typedef tiny_rpc_asio::detail::array<unsigned char, 16> bytes_type;
#endif
...
private:
  ...
  tiny_rpc_asio::detail::in6_addr_type addr_;
 ...
 *
 * @relates tiny_rpc_asio::ip::address_v6
 */
