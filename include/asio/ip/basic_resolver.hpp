...
public:
   ...
   */
  explicit basic_resolver(tiny_rpc_asio::io_service& io_service)
   ...
   * will be invoked with the tiny_rpc_asio::error::operation_aborted error code.
   */
  void cancel()
  {
  ...
  iterator resolve(const query& q)
  {
    ...
    tiny_rpc_asio::detail::throw_error(ec, "resolve");
    return i;
  }
   ...
   * entry.
   */
  iterator resolve(const query& q, tiny_rpc_asio::error_code& ec)
  {
   ...
   * entry.
   */
  iterator resolve(const endpoint_type& e, tiny_rpc_asio::error_code& ec)
  {
