...
/**
 * The tiny_rpc_asio::ip::basic_resolver_query class template describes a query
...
public:
  ...
  const tiny_rpc_asio::detail::addrinfo_type& hints() const
  {
    return hints_;
  }
...
private:
  tiny_rpc_asio::detail::addrinfo_type hints_;
