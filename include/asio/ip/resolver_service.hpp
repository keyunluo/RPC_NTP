...
#if defined(ASIO_WINDOWS_RUNTIME)
  typedef tiny_rpc_asio::detail::winrt_resolver_service<InternetProtocol>
    service_impl_type;
#else
  typedef tiny_rpc_asio::detail::resolver_service<InternetProtocol>
    service_impl_type;
#endif
...
public:
  ...
  explicit resolver_service(tiny_rpc_asio::io_service& io_service)
  ...
  ASIO_INITFN_RESULT_TYPE(ResolveHandler,
      void (tiny_rpc_asio::error_code, iterator_type))
  async_resolve(implementation_type& impl, const query_type& query,
      ASIO_MOVE_ARG(ResolveHandler) handler)
  {
    tiny_rpc_asio::detail::async_result_init<
      ResolveHandler, void (tiny_rpc_asio::error_code, iterator_type)> init(
