...
/**
 * The tiny_rpc_asio::local::basic_endpoint class template describes an endpoint
...
private:
  ...
  tiny_rpc_asio::local::detail::endpoint impl_;
};
 ...
 *
 * @relates tiny_rpc_asio::local::basic_endpoint
 */
