...
/// as tiny_rpc_asio::basic_stream_socket::async_write_some or
/// tiny_rpc_asio::async_write.
unspecified bytes_transferred;

/// An argument placeholder, for use with boost::bind(), that corresponds to
/// the iterator argument of a handler for asynchronous functions such as
/// tiny_rpc_asio::basic_resolver::async_resolve.
unspecified iterator;

/// An argument placeholder, for use with boost::bind(), that corresponds to
/// the signal_number argument of a handler for asynchronous functions such as
/// tiny_rpc_asio::signal_set::async_wait.
...
static boost::arg<1>& error
  = tiny_rpc_asio::placeholders::detail::placeholder<1>::get();
static boost::arg<2>& bytes_transferred
  = tiny_rpc_asio::placeholders::detail::placeholder<2>::get();
