...
public:
   ...
   * descriptor.
   */
  explicit basic_descriptor(tiny_rpc_asio::io_service& io_service)
   ...
   */
  basic_descriptor(tiny_rpc_asio::io_service& io_service,
   ...
   */
  tiny_rpc_asio::error_code assign(const native_handle_type& native_descriptor,
      tiny_rpc_asio::error_code& ec)
  {
   ...
   * tiny_rpc_asio::posix::descriptor_base::bytes_readable @n
   * tiny_rpc_asio::posix::descriptor_base::non_blocking_io
   *
   * @par Example
   * Getting the number of bytes ready to read:
   * @code
   * tiny_rpc_asio::posix::stream_descriptor descriptor(io_service);
   * ...
   * tiny_rpc_asio::posix::stream_descriptor::bytes_readable command;
