...
struct is_match_condition
{
  ...
  enum
  {
    value = tiny_rpc_asio::is_function<
        typename tiny_rpc_asio::remove_pointer<T>::type>::value
...
/**
 * @defgroup read_until tiny_rpc_asio::read_until
 *
 ...
 * @code tiny_rpc_asio::streambuf b;
 * tiny_rpc_asio::read_until(s, b, '\n');
 * std::istream is(&b);
 * std::string line;
...
std::size_t read_until(SyncReadStream& s,
    tiny_rpc_asio::basic_streambuf<Allocator>& b, char delim);
...
template <typename SyncReadStream, typename Allocator>
std::size_t read_until(SyncReadStream& s,
    tiny_rpc_asio::basic_streambuf<Allocator>& b, const std::string& delim);
 ...
 * @code tiny_rpc_asio::streambuf b;
 * tiny_rpc_asio::read_until(s, b, boost::regex("\r\n"));
 * std::istream is(&b);
 * std::string line;
 * std::getline(is, line); @endcode
 * After the @c read_until operation completes successfully, the buffer @c b
...
template <typename SyncReadStream, typename Allocator>
std::size_t read_until(SyncReadStream& s,
    tiny_rpc_asio::basic_streambuf<Allocator>& b, const boost::regex& expr);
 ...
 * @code typedef tiny_rpc_asio::buffers_iterator<
 *     tiny_rpc_asio::streambuf::const_buffers_type> iterator;
 *
 ...
 * }
 * ...
 * tiny_rpc_asio::streambuf b;
 * tiny_rpc_asio::read_until(s, b, match_whitespace);
 * @endcode
 *
 ...
 * ...
 * tiny_rpc_asio::streambuf b;
 * tiny_rpc_asio::read_until(s, b, match_char('a'));
 * @endcode
 */
template <typename SyncReadStream, typename Allocator, typename MatchCondition>
std::size_t read_until(SyncReadStream& s,
    tiny_rpc_asio::basic_streambuf<Allocator>& b, MatchCondition match_condition,
...
std::size_t read_until(SyncReadStream& s,
    ...
    MatchCondition match_condition, tiny_rpc_asio::error_code& ec,
    typename enable_if<is_match_condition<MatchCondition>::value>::type* = 0);

/*@}*/
/**
 * @defgroup async_read_until tiny_rpc_asio::async_read_until
 *
 ...
 * @code void handler(
 *   // Result of operation.
 *   const tiny_rpc_asio::error_code& error,
 *
 ...
 * @code tiny_rpc_asio::streambuf b;
 * ...
 * void handler(const tiny_rpc_asio::error_code& e, std::size_t size)
 * {
 *   if (!e)
 *   {
 *     std::istream is(&b);
 ...
 * }
 * ...
 * tiny_rpc_asio::async_read_until(s, b, '\n', handler); @endcode
 ...
 * }
 * ...
 * tiny_rpc_asio::async_read_until(s, b, boost::regex("\r\n"), handler); @endcode
 * After the @c async_read_until operation completes successfully, the buffer
 ...
 * ...
 * tiny_rpc_asio::streambuf b;
 * tiny_rpc_asio::async_read_until(s, b, match_whitespace, handler);
 * @endcode
 *
 ...
 * ...
 * tiny_rpc_asio::streambuf b;
 * tiny_rpc_asio::async_read_until(s, b, match_char('a'), handler);
 * @endcode
 */
