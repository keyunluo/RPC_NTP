...
#else
  : public tiny_rpc_asio::detail::service_base<signal_set_service>
#endif
{
public:
#if defined(GENERATING_DOCUMENTATION)
...
public:
  ...
  explicit signal_set_service(tiny_rpc_asio::io_service& io_service)
    : tiny_rpc_asio::detail::service_base<signal_set_service>(io_service),
  ...
  tiny_rpc_asio::error_code add(implementation_type& impl,
  ...
  tiny_rpc_asio::error_code remove(implementation_type& impl,
      int signal_number, tiny_rpc_asio::error_code& ec)
  {
  ...
  tiny_rpc_asio::error_code clear(implementation_type& impl,
      ...
      ASIO_MOVE_ARG(SignalHandler) handler)
  {
    detail::async_result_init<
      SignalHandler, void (tiny_rpc_asio::error_code, int)> init(
...
private:
  ...
  void fork_service(tiny_rpc_asio::io_service::fork_event event)
  {
