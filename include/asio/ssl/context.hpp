...
public:
  ...
  ASIO_DECL context(tiny_rpc_asio::io_service&, method m);
   ...
   * @note Calls @c SSL_CTX_clear_options.
   */
  ASIO_DECL tiny_rpc_asio::error_code clear_options(options o,
   ...
   * @note Calls @c SSL_CTX_set_options.
   */
  ASIO_DECL tiny_rpc_asio::error_code set_options(options o,
      tiny_rpc_asio::error_code& ec);
   ...
   * @note Calls @c SSL_CTX_set_verify.
   */
  ASIO_DECL tiny_rpc_asio::error_code set_verify_mode(
   ...
   * @note Calls @c SSL_CTX_set_verify_depth.
   */
  ASIO_DECL tiny_rpc_asio::error_code set_verify_depth(
   ...
   */
  template <typename VerifyCallback>
  tiny_rpc_asio::error_code set_verify_callback(VerifyCallback callback,
      tiny_rpc_asio::error_code& ec);
   ...
   * @note Calls @c SSL_CTX_load_verify_locations.
   */
  ASIO_DECL tiny_rpc_asio::error_code load_verify_file(
   ...
   * @note Calls @c SSL_CTX_get_cert_store and @c X509_STORE_add_cert.
   */
  ASIO_DECL tiny_rpc_asio::error_code add_certificate_authority(
   ...
   * @note Calls @c SSL_CTX_set_default_verify_paths.
   */
  ASIO_DECL tiny_rpc_asio::error_code set_default_verify_paths(
      tiny_rpc_asio::error_code& ec);
   ...
   * @note Calls @c SSL_CTX_load_verify_locations.
   */
  ASIO_DECL tiny_rpc_asio::error_code add_verify_path(
   ...
   * @note Calls @c SSL_CTX_use_certificate or SSL_CTX_use_certificate_ASN1.
   */
  ASIO_DECL tiny_rpc_asio::error_code use_certificate(
      const const_buffer& certificate, file_format format,
      tiny_rpc_asio::error_code& ec);
   ...
   * @note Calls @c SSL_CTX_use_certificate_file.
   */
  ASIO_DECL tiny_rpc_asio::error_code use_certificate_file(
      const std::string& filename, file_format format,
      tiny_rpc_asio::error_code& ec);
   ...
   * @note Calls @c SSL_CTX_use_certificate and SSL_CTX_add_extra_chain_cert.
   */
  ASIO_DECL tiny_rpc_asio::error_code use_certificate_chain(
   ...
   * @note Calls @c SSL_CTX_use_certificate_chain_file.
   */
  ASIO_DECL tiny_rpc_asio::error_code use_certificate_chain_file(
      const std::string& filename, tiny_rpc_asio::error_code& ec);
   ...
   * @note Calls @c SSL_CTX_use_PrivateKey or SSL_CTX_use_PrivateKey_ASN1.
   */
  ASIO_DECL tiny_rpc_asio::error_code use_private_key(
      const const_buffer& private_key, file_format format,
      tiny_rpc_asio::error_code& ec);
   ...
   * @note Calls @c SSL_CTX_use_PrivateKey_file.
   */
  ASIO_DECL tiny_rpc_asio::error_code use_private_key_file(
      const std::string& filename, file_format format,
      tiny_rpc_asio::error_code& ec);
   ...
   * @note Calls @c SSL_CTX_use_RSAPrivateKey or SSL_CTX_use_RSAPrivateKey_ASN1.
   */
  ASIO_DECL tiny_rpc_asio::error_code use_rsa_private_key(
      const const_buffer& private_key, file_format format,
      tiny_rpc_asio::error_code& ec);
   ...
   * @note Calls @c SSL_CTX_use_RSAPrivateKey_file.
   */
  ASIO_DECL tiny_rpc_asio::error_code use_rsa_private_key_file(
      const std::string& filename, file_format format,
      tiny_rpc_asio::error_code& ec);
   ...
   * @note Calls @c SSL_CTX_set_tmp_dh.
   */
  ASIO_DECL tiny_rpc_asio::error_code use_tmp_dh(
   ...
   * @note Calls @c SSL_CTX_set_tmp_dh.
   */
  ASIO_DECL tiny_rpc_asio::error_code use_tmp_dh_file(
      const std::string& filename, tiny_rpc_asio::error_code& ec);
   ...
   */
  template <typename PasswordCallback>
  tiny_rpc_asio::error_code set_password_callback(PasswordCallback callback,
      tiny_rpc_asio::error_code& ec);
...
private:
  ...
  ASIO_DECL tiny_rpc_asio::error_code do_set_verify_callback(
  ...
  ASIO_DECL tiny_rpc_asio::error_code do_set_password_callback(
  ...
  ASIO_DECL tiny_rpc_asio::error_code do_use_tmp_dh(
  ...
  tiny_rpc_asio::ssl::detail::openssl_init<> init_;
};
