...
public:
  do_init()
  {
    ...
    for (size_t i = 0; i < mutexes_.size(); ++i)
      mutexes_[i].reset(new tiny_rpc_asio::detail::mutex);
...
private:
  ...
  std::vector<tiny_rpc_asio::detail::shared_ptr<
        tiny_rpc_asio::detail::mutex> > mutexes_;

#if !defined(ASIO_WINDOWS) && !defined(__CYGWIN__)
  // The thread identifiers to be used by openssl.
  tiny_rpc_asio::detail::tss_ptr<void> thread_id_;
#endif // !defined(ASIO_WINDOWS) && !defined(__CYGWIN__)
...
tiny_rpc_asio::detail::shared_ptr<openssl_init_base::do_init>
openssl_init_base::instance()
{
  static tiny_rpc_asio::detail::shared_ptr<do_init> init(new do_init);
  return init;
}
