...
std::size_t io(Stream& next_layer, stream_core& core,
    const Operation& op, tiny_rpc_asio::error_code& ec)
{
  ...
  case engine::want_input_and_retry:
    ...
    if (tiny_rpc_asio::buffer_size(core.input_) == 0)
      core.input_ = tiny_rpc_asio::buffer(core.input_buffer_,
  ...
  case engine::want_output_and_retry:
    ...
    // transport.
    tiny_rpc_asio::write(next_layer,
    ...
    case 1: // Called after at least one async operation.
      do
      {
        ...
        case engine::want_input_and_retry:
          ...
          if (tiny_rpc_asio::buffer_size(core_.input_) != 0)
          {
          ...
          if (core_.pending_read_.expires_at() == core_.neg_infin())
          {
            ...
            next_layer_.async_read_some(
                tiny_rpc_asio::buffer(core_.input_buffer_),
        ...
        case engine::want_output:
          ...
          if (core_.pending_write_.expires_at() == core_.neg_infin())
          {
            ...
            tiny_rpc_asio::async_write(next_layer_,
        ...
        default:
          ...
          {
            next_layer_.async_read_some(
                tiny_rpc_asio::buffer(core_.input_buffer_, 0),
                ASIO_MOVE_CAST(io_op)(*this));
        ...
        case engine::want_input_and_retry:
          ...
          core_.input_ = tiny_rpc_asio::buffer(
