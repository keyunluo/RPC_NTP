...
template <typename VerifyCallback>
tiny_rpc_asio::error_code context::set_verify_callback(
    VerifyCallback callback, tiny_rpc_asio::error_code& ec)
{
...
void context::set_password_callback(PasswordCallback callback)
{
  ...
  tiny_rpc_asio::detail::throw_error(ec, "set_password_callback");
}

template <typename PasswordCallback>
tiny_rpc_asio::error_code context::set_password_callback(
