  ...
  : handle_(0)
{
  ...
  case context::sslv2_server:
    tiny_rpc_asio::detail::throw_error(
        tiny_rpc_asio::error::invalid_argument, "context");
    break;
  ...
  if (handle_ == 0)
  {
    ...
    tiny_rpc_asio::detail::throw_error(ec, "context");
  }

  set_options(no_compression);
}

context::context(tiny_rpc_asio::io_service&, context::method m)
  : handle_(0)
{
  context tmp(m);
  handle_ = tmp.handle_;
...
void context::clear_options(context::options o)
{
  tiny_rpc_asio::error_code ec;
  clear_options(o, ec);
  tiny_rpc_asio::detail::throw_error(ec, "clear_options");
}

tiny_rpc_asio::error_code context::clear_options(
    context::options o, tiny_rpc_asio::error_code& ec)
{
...
void context::set_options(context::options o)
{
  tiny_rpc_asio::error_code ec;
  set_options(o, ec);
  tiny_rpc_asio::detail::throw_error(ec, "set_options");
}

tiny_rpc_asio::error_code context::set_options(
    context::options o, tiny_rpc_asio::error_code& ec)
{
#if !defined(SSL_OP_NO_COMPRESSION)
  if ((o & context::no_compression) != 0)
  {
    ...
    handle_->comp_methods =
      tiny_rpc_asio::ssl::detail::openssl_init<>::get_null_compression_methods();
#endif // (OPENSSL_VERSION_NUMBER >= 0x00908000L)
    o ^= context::no_compression;
  }
#endif // !defined(SSL_OP_NO_COMPRESSION)
...
void context::set_verify_mode(verify_mode v)
{
  ...
  tiny_rpc_asio::detail::throw_error(ec, "set_verify_mode");
}

tiny_rpc_asio::error_code context::set_verify_mode(
    verify_mode v, tiny_rpc_asio::error_code& ec)
{
...
void context::set_verify_depth(int depth)
{
  ...
  tiny_rpc_asio::detail::throw_error(ec, "set_verify_depth");
}

tiny_rpc_asio::error_code context::set_verify_depth(
    int depth, tiny_rpc_asio::error_code& ec)
{
...
void context::load_verify_file(const std::string& filename)
{
  ...
  tiny_rpc_asio::detail::throw_error(ec, "load_verify_file");
}

tiny_rpc_asio::error_code context::load_verify_file(
    const std::string& filename, tiny_rpc_asio::error_code& ec)
{
  ::ERR_clear_error();
...
void context::add_certificate_authority(const const_buffer& ca)
{
  ...
  tiny_rpc_asio::detail::throw_error(ec, "add_certificate_authority");
}

tiny_rpc_asio::error_code context::add_certificate_authority(
    const const_buffer& ca, tiny_rpc_asio::error_code& ec)
{
  ::ERR_clear_error();
...
void context::set_default_verify_paths()
{
  ...
  tiny_rpc_asio::detail::throw_error(ec, "set_default_verify_paths");
}

tiny_rpc_asio::error_code context::set_default_verify_paths(
    tiny_rpc_asio::error_code& ec)
{
  ::ERR_clear_error();
...
void context::add_verify_path(const std::string& path)
{
  ...
  tiny_rpc_asio::detail::throw_error(ec, "add_verify_path");
}

tiny_rpc_asio::error_code context::add_verify_path(
    const std::string& path, tiny_rpc_asio::error_code& ec)
{
  ::ERR_clear_error();
    ...
    const const_buffer& certificate, file_format format)
{
  ...
  tiny_rpc_asio::detail::throw_error(ec, "use_certificate");
}

tiny_rpc_asio::error_code context::use_certificate(
    const const_buffer& certificate, file_format format,
    tiny_rpc_asio::error_code& ec)
{
  ::ERR_clear_error();
    ...
    const std::string& filename, file_format format)
{
  ...
  tiny_rpc_asio::detail::throw_error(ec, "use_certificate_file");
}

tiny_rpc_asio::error_code context::use_certificate_file(
    const std::string& filename, file_format format,
    tiny_rpc_asio::error_code& ec)
{
  int file_type;
...
void context::use_certificate_chain(const const_buffer& chain)
{
  ...
  tiny_rpc_asio::detail::throw_error(ec, "use_certificate_chain");
}

tiny_rpc_asio::error_code context::use_certificate_chain(
    const const_buffer& chain, tiny_rpc_asio::error_code& ec)
{
  ::ERR_clear_error();
  ...
  if (bio.p)
  {
    ...
    if (!cert.p)
    {
      ec = tiny_rpc_asio::error_code(ERR_R_PEM_LIB,
          tiny_rpc_asio::error::get_ssl_category());
      return ec;
    }
...
void context::use_certificate_chain_file(const std::string& filename)
{
  ...
  tiny_rpc_asio::detail::throw_error(ec, "use_certificate_chain_file");
}

tiny_rpc_asio::error_code context::use_certificate_chain_file(
    const std::string& filename, tiny_rpc_asio::error_code& ec)
{
  ::ERR_clear_error();
    ...
    const const_buffer& private_key, context::file_format format)
{
  ...
  tiny_rpc_asio::detail::throw_error(ec, "use_private_key");
}

tiny_rpc_asio::error_code context::use_private_key(
    const const_buffer& private_key, context::file_format format,
    tiny_rpc_asio::error_code& ec)
{
  ::ERR_clear_error();
    ...
    const std::string& filename, context::file_format format)
{
  ...
  tiny_rpc_asio::detail::throw_error(ec, "use_private_key_file");
}
    ...
    const const_buffer& private_key, context::file_format format)
{
  ...
  tiny_rpc_asio::detail::throw_error(ec, "use_rsa_private_key");
}

tiny_rpc_asio::error_code context::use_rsa_private_key(
    const const_buffer& private_key, context::file_format format,
    tiny_rpc_asio::error_code& ec)
{
  ::ERR_clear_error();
...
tiny_rpc_asio::error_code context::use_private_key_file(
    const std::string& filename, context::file_format format,
    tiny_rpc_asio::error_code& ec)
{
  int file_type;
    ...
    const std::string& filename, context::file_format format)
{
  ...
  tiny_rpc_asio::detail::throw_error(ec, "use_rsa_private_key_file");
}

tiny_rpc_asio::error_code context::use_rsa_private_key_file(
    const std::string& filename, context::file_format format,
    tiny_rpc_asio::error_code& ec)
{
  int file_type;
...
void context::use_tmp_dh(const const_buffer& dh)
{
  tiny_rpc_asio::error_code ec;
  use_tmp_dh(dh, ec);
  tiny_rpc_asio::detail::throw_error(ec, "use_tmp_dh");
}

tiny_rpc_asio::error_code context::use_tmp_dh(
    const const_buffer& dh, tiny_rpc_asio::error_code& ec)
{
  ::ERR_clear_error();
...
void context::use_tmp_dh_file(const std::string& filename)
{
  ...
  tiny_rpc_asio::detail::throw_error(ec, "use_tmp_dh_file");
}

tiny_rpc_asio::error_code context::use_tmp_dh_file(
    const std::string& filename, tiny_rpc_asio::error_code& ec)
{
  ::ERR_clear_error();
...
tiny_rpc_asio::error_code context::do_use_tmp_dh(
    BIO* bio, tiny_rpc_asio::error_code& ec)
{
  ::ERR_clear_error();
...
tiny_rpc_asio::error_code context::do_set_verify_callback(
    detail::verify_callback_base* callback, tiny_rpc_asio::error_code& ec)
{
  if (SSL_CTX_get_app_data(handle_))
  {
...
tiny_rpc_asio::error_code context::do_set_password_callback(
    detail::password_callback_base* callback, tiny_rpc_asio::error_code& ec)
{
  if (handle_->default_passwd_callback_userdata)
