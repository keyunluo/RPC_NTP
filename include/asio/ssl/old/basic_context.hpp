...
public:
  ...
  /// Constructor.
  basic_context(tiny_rpc_asio::io_service& io_service, method m)
    : service_(tiny_rpc_asio::use_service<Service>(io_service)),
      impl_(service_.null())
  {
  ...
  void set_options(options o)
  {
    ...
    tiny_rpc_asio::detail::throw_error(ec);
  }
   ...
   */
  tiny_rpc_asio::error_code set_options(options o,
      tiny_rpc_asio::error_code& ec)
  {
   ...
   * @param ec Set to indicate what error occurred, if any.
   */
  tiny_rpc_asio::error_code set_verify_mode(verify_mode v,
      tiny_rpc_asio::error_code& ec)
  {
   ...
   * @param ec Set to indicate what error occurred, if any.
   */
  tiny_rpc_asio::error_code load_verify_file(const std::string& filename,
      tiny_rpc_asio::error_code& ec)
  {
   ...
   * @param ec Set to indicate what error occurred, if any.
   */
  tiny_rpc_asio::error_code add_verify_path(const std::string& path,
      tiny_rpc_asio::error_code& ec)
  {
   ...
   * @param ec Set to indicate what error occurred, if any.
   */
  tiny_rpc_asio::error_code use_certificate_file(const std::string& filename,
      file_format format, tiny_rpc_asio::error_code& ec)
  {
   ...
   * @param ec Set to indicate what error occurred, if any.
   */
  tiny_rpc_asio::error_code use_certificate_chain_file(
   ...
   * @param ec Set to indicate what error occurred, if any.
   */
  tiny_rpc_asio::error_code use_private_key_file(const std::string& filename,
      file_format format, tiny_rpc_asio::error_code& ec)
  {
   ...
   * @param ec Set to indicate what error occurred, if any.
   */
  tiny_rpc_asio::error_code use_rsa_private_key_file(
   ...
   * @param ec Set to indicate what error occurred, if any.
   */
  tiny_rpc_asio::error_code use_tmp_dh_file(const std::string& filename,
      tiny_rpc_asio::error_code& ec)
  {
