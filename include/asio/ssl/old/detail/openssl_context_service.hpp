...
class openssl_context_service
  : public tiny_rpc_asio::detail::service_base<openssl_context_service>
{
public:
  ...
  // Constructor.
  openssl_context_service(tiny_rpc_asio::io_service& io_service)
    : tiny_rpc_asio::detail::service_base<openssl_context_service>(io_service)
  {
  }
  ...
  void create(impl_type& impl, context_base::method m)
  {
    ...
    case context_base::sslv2_server:
      tiny_rpc_asio::detail::throw_error(tiny_rpc_asio::error::invalid_argument);
      break;
  ...
  tiny_rpc_asio::error_code set_options(impl_type& impl,
      context_base::options o, tiny_rpc_asio::error_code& ec)
  {
  ...
  tiny_rpc_asio::error_code set_verify_mode(impl_type& impl,
      context_base::verify_mode v, tiny_rpc_asio::error_code& ec)
  {
  ...
  tiny_rpc_asio::error_code load_verify_file(impl_type& impl,
  ...
  tiny_rpc_asio::error_code add_verify_path(impl_type& impl,
  ...
  tiny_rpc_asio::error_code use_certificate_file(impl_type& impl,
  ...
  tiny_rpc_asio::error_code use_certificate_chain_file(impl_type& impl,
      const std::string& filename, tiny_rpc_asio::error_code& ec)
  {
  ...
  tiny_rpc_asio::error_code use_private_key_file(impl_type& impl,
      const std::string& filename, context_base::file_format format,
      tiny_rpc_asio::error_code& ec)
  {
    int file_type;
  ...
  tiny_rpc_asio::error_code use_rsa_private_key_file(impl_type& impl,
      const std::string& filename, context_base::file_format format,
      tiny_rpc_asio::error_code& ec)
  {
    int file_type;
  ...
  tiny_rpc_asio::error_code use_tmp_dh_file(impl_type& impl,
      const std::string& filename, tiny_rpc_asio::error_code& ec)
  {
  ...
  tiny_rpc_asio::error_code set_password_callback(impl_type& impl,
      Password_Callback callback, tiny_rpc_asio::error_code& ec)
  {
