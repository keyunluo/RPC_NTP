...
#else
  : public tiny_rpc_asio::detail::service_base<stream_service>
#endif
{
private:
...
public:
  ...
  explicit stream_service(tiny_rpc_asio::io_service& io_service)
    : tiny_rpc_asio::detail::service_base<stream_service>(io_service),
