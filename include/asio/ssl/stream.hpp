...
using tiny_rpc_asio::ssl::old::stream;
 ...
 * tiny_rpc_asio::ssl::context ctx(tiny_rpc_asio::ssl::context::sslv23);
 * tiny_rpc_asio::ssl::stream<asio:ip::tcp::socket> sock(io_service, ctx);
 * @endcode
 *
 * @par Concepts:
...
public:
   ...
   * @note Calls @c SSL_set_verify.
   */
  tiny_rpc_asio::error_code set_verify_mode(
   ...
   * @note Calls @c SSL_set_verify_depth.
   */
  tiny_rpc_asio::error_code set_verify_depth(
  ...
  void set_verify_callback(VerifyCallback callback)
  {
    ...
    tiny_rpc_asio::detail::throw_error(ec, "set_verify_callback");
  }
  ...
  void handshake(handshake_type type)
  {
    tiny_rpc_asio::error_code ec;
    handshake(type, ec);
    tiny_rpc_asio::detail::throw_error(ec, "handshake");
  }
   ...
   * @param ec Set to indicate what error occurred, if any.
   */
  tiny_rpc_asio::error_code handshake(handshake_type type,
      tiny_rpc_asio::error_code& ec)
  {
  ...
  template <typename ConstBufferSequence>
  tiny_rpc_asio::error_code handshake(handshake_type type,
      const ConstBufferSequence& buffers, tiny_rpc_asio::error_code& ec)
  {
      ...
      ASIO_MOVE_ARG(HandshakeHandler) handler)
  {
    ...
    tiny_rpc_asio::detail::async_result_init<
      HandshakeHandler, void (tiny_rpc_asio::error_code)> init(
      ...
      ASIO_MOVE_ARG(BufferedHandshakeHandler) handler)
  {
    ...
    tiny_rpc_asio::detail::async_result_init<BufferedHandshakeHandler,
      void (tiny_rpc_asio::error_code, std::size_t)> init(
   ...
   * @param ec Set to indicate what error occurred, if any.
   */
  tiny_rpc_asio::error_code shutdown(tiny_rpc_asio::error_code& ec)
  {
  ...
  async_shutdown(ASIO_MOVE_ARG(ShutdownHandler) handler)
  {
    ...
    tiny_rpc_asio::detail::async_result_init<
      ShutdownHandler, void (tiny_rpc_asio::error_code)> init(
