...
public:
   ...
   */
  explicit strand(tiny_rpc_asio::io_service& io_service)
    : service_(tiny_rpc_asio::use_service<
        tiny_rpc_asio::detail::strand_service>(io_service))
  {
...
private:
  tiny_rpc_asio::detail::strand_service& service_;
  tiny_rpc_asio::detail::strand_service::implementation_type impl_;
};

/// (Deprecated: Use tiny_rpc_asio::io_service::strand.) Typedef for backwards
/// compatibility.
typedef tiny_rpc_asio::io_service::strand strand;
