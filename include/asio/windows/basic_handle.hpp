...
public:
   ...
   */
  explicit basic_handle(tiny_rpc_asio::io_service& io_service)
   ...
   */
  basic_handle(tiny_rpc_asio::io_service& io_service,
   ...
   */
  tiny_rpc_asio::error_code assign(const native_handle_type& handle,
      tiny_rpc_asio::error_code& ec)
  {
