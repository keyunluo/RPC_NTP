...
#else
  : public tiny_rpc_asio::detail::service_base<object_handle_service>
#endif
{
public:
#if defined(GENERATING_DOCUMENTATION)
...
public:
  ...
  explicit object_handle_service(tiny_rpc_asio::io_service& io_service)
    : tiny_rpc_asio::detail::service_base<object_handle_service>(io_service),
  ...
  void wait(implementation_type& impl, tiny_rpc_asio::error_code& ec)
  {
      ...
      ASIO_MOVE_ARG(WaitHandler) handler)
  {
    tiny_rpc_asio::detail::async_result_init<
      WaitHandler, void (tiny_rpc_asio::error_code)> init(
