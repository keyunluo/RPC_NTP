...
#else
  : public tiny_rpc_asio::detail::service_base<stream_handle_service>
#endif
{
public:
#if defined(GENERATING_DOCUMENTATION)
...
public:
  ...
  explicit stream_handle_service(tiny_rpc_asio::io_service& io_service)
    : tiny_rpc_asio::detail::service_base<stream_handle_service>(io_service),
